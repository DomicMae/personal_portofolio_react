            ...
            >
              ...
              <div className="card-body px-10 pb-6 font-redhat">
                ...
                <p className="text-base leading-relaxed text-justify text-white">
                  ...
                  kurang memperhatikan kandungan gizi makanannya.
                </p>
              </div>
            </a>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="card-body text-custom-yellow px-10 pb-6 font-redhat">
                ...
                <p className="text-base leading-relaxed text-justify text-white">
                  Project Pujasera ini adalah hasil kerja tim saya sebagai tugas
                  kuliah. Saya bertanggung jawab di bagian Back-end dan aktif
                  berdiskusi dengan anggota tim untuk memastikan seluruh sistem
                  berjalan sesuai kebutuhan klien.
                </p>
              </div>
            </a>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="card-body text-custom-yellow px-10 pb-6 font-redhat">
                ...
                <p className="text-base leading-relaxed text-justify text-white">
                  Website ini dirancang agar mudah digunakan oleh customer untuk
                  menyampaikan komplain dan memantau progresnya secara
          ...
          >
            ...
            >
              ...
              <div className="card-body text-custom-yellow px-10 pb-6 font-redhat">
                ...
                <p className="text-base leading-relaxed text-justify text-white">
                  Landing page profesional untuk Company Profile Dafco Resource,
                  sebuah perusahaan komoditas kopra yang menonjolkan nilai
            ...
            >
              ...
              <div className="card-body text-custom-yellow px-10 pb-6 font-redhat">
                ...
                <p className="text-base leading-relaxed text-justify text-white">
                  ...
                  tampilan lebih menarik dan sesuai konsep.
                </p>
              </div>
            </a>
          </motion.div>
            ...
            >
              ...
              <div className="card-body text-custom-yellow px-10 pb-6 font-redhat">
                ...
                <p className="text-base leading-relaxed text-justify text-white">
                  ...
                  sebagai Android Developer, berkolaborasi dengan tim backend
                  untuk memastikan integrasi data berjalan baik dan sesuai
                  keinginan klien.
                </p>
              </div>
            </a>
